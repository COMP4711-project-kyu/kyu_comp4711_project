            ...
            <div class="row">
                <div class="col-md-12 contact">
                    <form method="post" action="/contact/confirm">
                        <div class="to">
                            <input name="name" id="name" type="text" class="text" value="Name" onfocus="this.value = '';" onblur="if (this.value == '') {
                                        this.value = 'Name';
                                    }">
                            <input id="email" name="email" type="text" class="text" value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {
                                        this.value = 'Email';
                                    }">
                            <input id="subject" name="submect" type="text" class="text" value="Subject" onfocus="this.value = '';" onblur="if (this.value == '') {
                                        this.value = 'Subject';
                                    }">
                            <div class="error">{error}</div>
                        </div>
                        <div class="text">
                            <textarea id="message" name="message" value="Message" onfocus="this.value = '';" onblur="if (this.value == '') {
                                        this.value = 'Message';
                                    }">Message</textarea>
